...
****************************************************************************************************************************
*PART I: GETTING REGRESSIONS RESULTS USING AUTHOR'S DATASET
****************************************************************************************************************************
...
****************************************************************************************************************************
*PART 2 : PREPARING OUR OWN DATA: CLEANING NFHS3 OURSELVES
****************************************************************************************************************************

*note: we have cleaned NFHS3 ourselves. To that the authors' cleaned NFHS2 data is appended
*Since it was not feasible to map every wife with the exact husband
*As per our discussion meeting

*-------------------------------------------------------------------------------
*Getting the NFHS2 part (1998,1999,2000) from authors' dataset
*-------------------------------------------------------------------------------

*Note: We would be appending our cleaned NFHS3 to this, as per previous discussions and issues with the data itself
...
*-------------------------------------------------------------------------------
* APPENDING OUR NFHS3 UNDER AUTHOR'S NFHS2
*-------------------------------------------------------------------------------
...
*-------------------------------------------------------------------------------
* PREPARING OUR OWN CRIME DATA (COLLECTED INDEPENDENTLY)
*-------------------------------------------------------------------------------
clear all
*preparing our Crime data - we independently collected this data from reports etc.
...
*-------------------------------------------------------------------------------
*TABLE 1 PANEL A - ON OUR DATASET
*-------------------------------------------------------------------------------
...
*****************************************************************************************************************************
*PART 4: CHECKING A SAMPLE RESTRICTION ON AUTHOR'S DATASET, USING AUTHOR'S REGRESSIONS ONLY
*****************************************************************************************************************************
...
******************************************************************************************************************************
*PART 5: EXPLORING ALTERNATIVE MODELS
******************************************************************************************************************************
